...
import Block from '../../BeneficiForm/Block/Block';
...
const MasterVillage = () => {
    ...
    const onSubmit = values => {
        axios.post(`http://localhost:3009/api/vill`, {
            name: values.name, block_id: values.block
        }, { headers })
            .then((res) => {
    ...
    return (
        <div>
            ...
            <Formik
                ...
                onSubmit={onSubmit}>
                <Form className='h-full flex flex-col gap-3 mt-32 mb-10 px-20'>
                    <div className="w-full flex flex-col justify-center lg:justify-around lg:flex-row">
                        <div className="w-full lg:w-1/2 px-8 flex flex-col gap-3">
                            <div className="flex flex-col gap-2">
                                <h1 className='text-3xl font-bold'>Create A New Village</h1>
                            ...
                            <div className=" flex flex-col gap-1 mt-4">
                                <label htmlFor="name" className="font-bold text-gray-900">Village Name</label>

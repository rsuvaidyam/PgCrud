...
const MasterDistrict = () => {
    ...
    const onSubmit = values => {
        axios.post(`http://localhost:3009/api/dist`, {
            name: values.name, state_id: values.state
        }, { headers })
            .then((res) => {
                    ...
                    <div className="w-full flex flex-col justify-center lg:justify-around lg:flex-row">
                        <div className="w-full lg:w-1/2 px-8 flex flex-col gap-3">
                            <div className="flex flex-col gap-2">
                                <h1 className='text-3xl font-bold'>Create A New District</h1>
                            ...
                            <div className=" flex flex-col gap-1 mt-4">
                                <label htmlFor="name" className="font-bold text-gray-900">District Name</label>
